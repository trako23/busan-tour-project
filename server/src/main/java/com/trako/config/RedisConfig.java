...
public class RedisConfig {
	 ...
	 @Value("${spring.redis.host}")
	  ...
	  @Bean
	  public RedisTemplate<String, RefreshTokenDTO> redisTemplate() {
...
//	    redisTemplate.setConnectionFactory(redisConnectionFactory());
		  ...
		  RedisTemplate<String, RefreshTokenDTO> redisTemplate = new RedisTemplate<>();
		    ...
		    // 값을 JSON 형식으로 직렬화하도록 설정
		    Jackson2JsonRedisSerializer<RefreshTokenDTO> serializer = new Jackson2JsonRedisSerializer<>(RefreshTokenDTO.class);
