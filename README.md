...
![project-board-image](C:\Users\USER\Desktop\git-project\integrated-banking-system\setupImages\project-board-1.png)
...
![project-roadmap-image](C:\Users\USER\Desktop\git-project\integrated-banking-system\setupImages\project-roadmap-1.png)
...
![add-date-into-issue](C:\Users\USER\Desktop\git-project\integrated-banking-system\setupImages\new-config-2.png)
...
![project-roadmap-image](C:\Users\USER\Desktop\git-project\integrated-banking-system\setupImages\new-config-field-1.png)

- 일정을 등록하기 위해서는 캘린더 우측 상단에 있는 Date fields에서 필드 생성을 해야 하는데, State와 End 날짜에 해당하는 필드를 각각 설정해줘야 함

![create-field-2](C:\Users\USER\Desktop\git-project\integrated-banking-system\setupImages\config-field-2.png)
